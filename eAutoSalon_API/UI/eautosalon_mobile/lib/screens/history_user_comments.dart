      ...
      title: 'Vaši komentari',
       body: Padding(
        ...
        SingleChildScrollView(
          ...
          ? Column(
            children: list.map((KomentarHistorija item) => buildCommentBox(item)).toList(),
          )
          :
          noDataContainer(),
        )
        ...
        children: [
          Row(
            children: [
              ...
              Text(comment.naslov?.toUpperCase() ?? "null", style: const TextStyle(color: Colors.black54, fontWeight: FontWeight.w400, fontSize: 14),),
            ],
          ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Text(comment.sadrzaj ?? "null", style: const TextStyle(color: Colors.black87, fontSize: 16, fontWeight: FontWeight.w500),)
            ],
          )
        ],
      ),
